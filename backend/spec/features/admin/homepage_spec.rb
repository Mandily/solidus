...
describe "Homepage", :type => :feature do
  ...
  context 'as admin user' do
    ...
    context "visiting the products tab" do
      ...
      it "should have a link to products" do
        within('.admin-subnav') { page.find_link("Products")['/admin/products'] }
      end

      it "should have a link to option types" do
        within('.admin-subnav') { page.find_link("Option Types")['/admin/option_types'] }
      end

      it "should have a link to properties" do
        within('.admin-subnav') { page.find_link("Properties")['/admin/properties'] }
      end

      it "should have a link to prototypes" do
        within('.admin-subnav') { page.find_link("Prototypes")['/admin/prototypes'] }
      end
    end
  end
